...
| **Python3**                      | [pylint](https://www.pylint.org/) / [flake8](https://flake8.pycqa.org/en/latest/) / [black](https://github.com/psf/black) / [isort](https://pypi.org/project/isort/) / [pydocstyle](https://pydocstyle.org/) |
...
| **PYTHON_PYDOCSTYLE_CONFIG_FILE**  | `.pydocstyle.ini`               | Filename for [pydocstyle configuration](http://www.pydocstyle.org/en/stable/usage.html#configuration-files) (ex: `.pydocstyle.ini`, `.pydocstylerc`)                                                                 |
...
| **VALIDATE_PYTHON_PYDOCSTYLE**     | `true`                          | Flag to enable or disable the linting process of the Python language. (Utilizing: pydocstyle)                                                                                                                        |
